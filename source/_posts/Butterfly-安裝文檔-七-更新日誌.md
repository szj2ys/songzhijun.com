...
1. 適配 hexo 5.0.0 的 prismjs, 代碼主题和各項功能
...
17. disqus/disqusjs/facebook comments 可隨夜間模式按鈕切換而轉換主题
...
2. 增加系統Darkmode切換監控，當系統切換Darkmode時，主题會立刻切換
...
15. 增加在綫聊天 Chat Services (chatra/tidio/daovoice/gitter), 可配置主题chat按鈕替換原在綫聊天按鈕
...
11. 修復評論utterances 在display_mode設置為dark時，仍顯示light主题的bug
...
10. 修復tag plugins 的gist 在不同主题下的背景顏色問題(黑色主题下，文字不易觀看)
...
2. Feature: 文章頁增加美化(原 melody主题功能),並增加更改標題前綴圖標和顏色
...
3. Feature: 增加 Note (Bootstrap Callout) (移植於next主题)
